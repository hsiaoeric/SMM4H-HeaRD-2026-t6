...
# Number of ordinal thresholds (K-1 for CORAL)
T_NUM_THRESHOLDS = T_NUM_LABELS - 1  # 3
N_NUM_THRESHOLDS = N_NUM_LABELS - 1  # 3

# Default model
DEFAULT_ENCODER = "google/medgemma-1.5-4b-it"
DEFAULT_MAX_LENGTH = 2048

# LoRA defaults
DEFAULT_LORA_R = 16
DEFAULT_LORA_ALPHA = 32
DEFAULT_LORA_DROPOUT = 0  # Unsloth optimizes for dropout=0
